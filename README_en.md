...
**A courtroom ruled that "design" itself caused harm. The attention economy is ending. This book draws the design brief for what comes next.**
...
The attention economy is ending. But no one yet knows what comes next.

This book is written to draw that "next." It does not present a finished model. **It presents a Design Brief — a set of design conditions.**

Beginning with a structural anatomy of the attention economy, this book traces how courts established the new legal concept of "design liability," the invisible trillion-dollar social costs, the attention tax as a new axis of inequality, the "metrics trap" proven by Facebook's MSI (Meaningful Social Interactions) failure, transition-era experiments and their failures, the redesign of creator compensation, the definition of "true engagement" grounded in Self-Determination Theory (SDT), and culminates in six design conditions for the next-generation social platform.

**This book does not write answers. It writes a blueprint. The person who builds the next SNS might be you, after reading these design conditions.**
...
| --- | --- | --- |
| [the-attention-economy-is-over_JP.md](./docs/jp/the-attention-economy-is-over_JP.md) | 🇯🇵 Japanese | Full text (Japanese edition) |
| [the-attention-economy-is-over_EN.md](./docs/en/the-attention-economy-is-over_EN.md) | 🇺🇸 English | Full text (English edition) |

---

## 📑 Table of Contents

- **Prologue:** The $6 Million Verdict — The Day a Court Judged "Design"
- **Chapter 1:** The Anatomy of the Attention Economy
- **Chapter 2:** When Courts Judged "Design" — From Content Liability to Design Liability
- **Chapter 3:** The Invisible Trillion-Dollar Cost
- **Chapter 4:** The Attention Tax — A New Axis of Inequality
- **Chapter 5:** The "Metrics Trap" Facebook Proved — The Failure of MSI
- **Chapter 6:** Transition-Era Experiments — What Moved and What Failed
- **Chapter 7:** Redesigning Creator Compensation
- **Chapter 8:** What Is "True Engagement"? — Self-Determination Theory (SDT)
- **Chapter 9:** Design Brief — Six Design Conditions for the Next-Generation SNS
...
| **A Trillion Dollars and a Firebomb** | The parallel realities of the AI era — depicting the asymmetry born from the same structure | [GitHub](https://github.com/Leading-AI-IO/a-trillion-and-a-firebomb) |
...
Issues and Pull Requests are welcome. Contributions on feedback to the structural analysis in this book, additional information on SNS regulation developments in various countries and regions, corrections, and translations are all appreciated.
